...
1. Descarga esta carpeta en tu computadora o clona el repositorio.
2. Abre la terminal (Símbolo del sistema).
3. Entra a la carpeta del juego usando el comando `cd`.
4. Escribe el siguiente comando para que inicie la misión:
   ```bash
   python main.py
   ```
